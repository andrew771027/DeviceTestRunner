...
- [x] JSON result generation is implemented.
- [x] Unit and integration tests are committed.
- [x] A runnable sample configuration is committed.
- [x] Release tag `v1.0.0` exists.
