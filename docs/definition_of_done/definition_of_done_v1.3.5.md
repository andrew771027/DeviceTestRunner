...
- [x] Executor, artifact, runner, and integration regressions are covered.
- [x] v1.3 lifecycle behavior remains supported.
- [x] Architecture documentation for v1.3.5 is committed.
- [x] Release tag `v1.3.5` exists.
