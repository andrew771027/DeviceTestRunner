...
class ProcessTerminator:
    ...
    def terminate_process_group(self, process: subprocess.Popen) -> ProcessTerminationResult:
        ...
        #
        exited = self._wait_for_exit(process=process, timeout_seconds=self.grace_period_seconds)
    ...
    def _wait_for_exit(self, process: subprocess.Popen, timeout_seconds: float) -> bool:
