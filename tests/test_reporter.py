...
from runner.models import RunResult, StepResult, ExecutionSummary, RunMetadata

@pytest.mark.parametrize(argnames="metadata, summary, step_results", 
                     argvalues=
                     [
                        (
                        RunMetadata(
...
def test_save_result_json(tmp_path: Path, metadata: RunMetadata, summary: ExecutionSummary, step_results: List[StepResult]):
